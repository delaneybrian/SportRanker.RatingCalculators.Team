...
class NhlFixtureResultHandler:
    ...
    def handle(self, message):
        self.logger.info_log("NHL handler fixture result recieved")
        ...
        if (home_team_details != None
            ...
            home_new_rating, away_new_rating = self.elo_calculator.calculate_new_ratings(MessagingConstants.NHL,
                                                     home_team_rating, away_team_rating, home_team_score, away_team_score)

            home_rating_change_message = {
                RankingChangeConstants.SPORT_ID: SportId.NHL,
            ...
            self.logger.info_log("Cannot Publish NHL Rating Change Message As Team Is Null")