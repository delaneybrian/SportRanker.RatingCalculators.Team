...
class MlbFixtureResultHandler:
    ...
    def handle(self, message):
        self.logger.info_log("MLB handler fixture result recieved")
        ...
        if (home_team_details != None
            ...
            self.logger.info_log("Cannot Publish MLB Rating Change Message As Team Is Null")